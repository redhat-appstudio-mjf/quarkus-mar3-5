...
2) Go to the `Data Science Projects` section and access your application's project named `quarkus-mar3-5`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `quarkus-mar3-5-notebook`.
...
5) In the terminal, run `cd quarkus-mar3-5` to navigate to your sample app's directory.
